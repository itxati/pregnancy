...
const List<BabyMilestone> babyMilestones = [
  ...
  BabyMilestone(
    ...
    title: '2–3 Years',
    milestones: [
      "Runs or climbs stairs",
      "Kicks ball",
      "Eats properly with spoon",
      "Draws straight lines or simple shapes",
      "Engages in spontaneous drawing",
  ...
  BabyMilestone(
    ...
    milestones: [
      "Walks steadily",
      "Tries to eat with spoon or hand",
      "Copies domestic chores (imitates adults)",
      "Scribbles with crayon or pencil",
      "Speaks 5–10 words",
      "Points to 3 body parts",
      "Plays using a single toy meaningfully",
    ],
  ),
];
