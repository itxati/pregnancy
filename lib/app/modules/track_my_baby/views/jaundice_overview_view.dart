...
class JaundiceOverviewView extends StatelessWidget {
  final List<BabyHealthInfo> data;
  const JaundiceOverviewView({super.key, required this.data});

  @override
  Widget build(BuildContext context) {
    final overviewData = data
        .where((item) =>
            item.title.contains('What Every Mother Should Know') ||
            item.title.contains('Breastfeeding and Jaundice'))
        .toList();
    ...
    return ListView(
      ...
      children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'essential_information_for_parents'.tr,
        ...
        // Overview content
        ...overviewData.map((item) => _buildInfoCard(context, item)),
      ],
    );
  }
