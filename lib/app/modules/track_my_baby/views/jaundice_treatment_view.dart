...
class JaundiceTreatmentView extends StatelessWidget {
  final List<BabyHealthInfo> data;
  const JaundiceTreatmentView({super.key, required this.data});

  @override
  Widget build(BuildContext context) {
    final treatmentData = data
        .where((item) =>
            item.title.contains('Treatment Options') ||
            item.title.contains('Complications'))
        .toList();
    ...
    return ListView(
      ...
      children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'medical_interventions_and_care'.tr,
        ...
        // Treatment content
        ...treatmentData.map((item) => _buildInfoCard(context, item)),
      ],
    );
  }
